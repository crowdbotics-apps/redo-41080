"""
Django settings for redo_41080 project.
...
WSGI_APPLICATION = 'redo_41080.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "redo_41080 API",
    "DESCRIPTION": "API documentation for redo_41080 App",
    "VERSION": "v1",
}
